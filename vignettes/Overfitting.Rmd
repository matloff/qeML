...
* Among these infinitely solutions for b, we might speculate that some
  of them do better on the test set than do the standard ones.  As
  noted, this has been confirmed empirically.
...
* One common way to choose b among those infinitely many solutions is to
  ...
  shrinkage estimator, analogous to the LASSO.  But smaller quantities
  have small variance, and meanwhile, if the bias doesn't increase much,
  we attain a smaller Mean Squared Error.

By the way, the function **penroseLin()** in the regtools package (on
