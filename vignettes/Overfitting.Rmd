...
But again, this varies from one training dataset to another.  One can
```{marginfigure}
...
```
Again, note that this reflects the variance in the b<sub>i</sub> from
one sample training set to another.
