...
Expected value notation, E(), is used in a couple of places, but is
explained intuitively in the given context, and is not vital to the
exposition.
...
S<sup>2</sup> comes out...a...little...too...small.   There is a *bias*
here of

&sigma;<sup>2</sup> - ((n-1)/n) &sigma;<sup>2</sup> =
(1/n) &sigma;<sup>2</sup>
