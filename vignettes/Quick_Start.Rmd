...
Say we wish to predict player weights.  For the random forests ML
...
accuracy.  The remaining data form the *training set*.  After a model is
fit to the training set, we use it to predict the holdout data.  To
...
above accuracy numbers.  To gauge the predictedive power of a model over
