...
By default, the data is partitioned into a training set and a holdout
set, with the model being fit on the former and then tested on the
latter. 
...
it's the sum of {b<sub>i</sub>|.  Limiting the size of some statistical
estimator in general is termed *regularization*.
