...
* The LASSO has the appealing property that it can be used for feature
...
* Let's first consider the views of ML specialists (CMLSs).  In our view
  ...
  * CMLSs tend to distinguish between "tabular" and "nontabular" data.
    ...
    * CMLSs view linear and generalized linear models as valuable,
      ...
      in which elaborate hyperparameter optimization will be done.  They
...
* Here are some views (general, not CMLSs) to consider:
    ...
    * A key question is whether there is a ageneral monotonic
