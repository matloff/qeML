...
> The points don't **exactly** line on a straight line.  It's important
> to keep in mind:  (a) We are merely setting up an approximate
> model, one that is close enough to reality to be useful; and 
> (b) these are sample means, subject to sampling variation.
