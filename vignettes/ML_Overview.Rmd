...
of the time, similar to the 0.5053763 value found above.  

> ~ The discrepancy is due to the latter figure being based on a holdout set.
...
##  Some views (general, not CMLSs) to consider
