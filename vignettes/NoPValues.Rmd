...
output above.  But actually, the impact of family income is not very
large.  Here's why:
...
```{marginfigure}
The same concerns, e.g. bias in our data collection methods, also
applies to settings in which we "just want to see whether the effect is
positive or negative."  A "significant" but minuscule difference in one
direction could be due to such inaccuracies,  So here too, it's
important to restrict attention to substantial differences.
```
