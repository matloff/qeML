...
interaction terms, by doing predictions of both models on a particle X
value:
...
We see here that adding in term interaction term changed the
predictions--and the estimated value of the regession function--by only
about 0.02 out of a 40.23 baseline.  So, we may well prefer the simpler,
...
This central issue in the above examples, and essentially in any other
