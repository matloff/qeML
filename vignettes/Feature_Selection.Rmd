...
* Avoiding overfitting.
    ...
    ```{marginfigure}
    The famous Variance-Bias Tradeoff.  
    ```
...
```{marginfigure}
The LASSO's historical antecedent, *ridge regression* was developed
specifically for dealing with the multicollinearity problem we saw
above.  The LASSO has this property too, but in addition it aids in
feature selection.
```
